...
4. `npm --prefix conventions/scripts run executor -- --route collect_phase_report`
5. `npm --prefix conventions/scripts run executor -- --route collect_evidence`
6. `npm --prefix conventions/scripts run executor -- --route validate_report_evidence`
