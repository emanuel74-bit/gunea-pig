...
description: Implementation agent that performs only approved code changes within allowed scope after pre-implementation gate passes.
allowed-tools:
  - Read
  - Grep
  - Glob
...
Convention agent id: `implementation_agent`  
Category: `implementation`  
Authority level: `source_edit_authority`
...
Activate this subagent when the validated phase bundle names owner agent `implementation_agent` or when the active phase is one of:
- `implementation`
