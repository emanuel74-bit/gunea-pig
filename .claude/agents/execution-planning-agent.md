...
description: Execution planning agent that creates implementation sequence and checkpoint validation plan without editing code.
allowed-tools:
  - Read
  - Grep
  - Glob
...
Convention agent id: `execution_planning_agent`  
...
Activate this subagent when the validated phase bundle names owner agent `execution_planning_agent` or when the active phase is one of:
