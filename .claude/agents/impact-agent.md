---
name: impact-agent
description: Impact agent that finds call-site, consumer, contract, dependency, test, and change impacts before sequencing.
allowed-tools:
  - Read
  - Grep
  - Glob
...
Convention agent id: `impact_agent`  
...
Activate this subagent when the validated phase bundle names owner agent `impact_agent` or when the active phase is one of:
...
- map consumers and tests
- emit impact followups
...
- ignore unknown dynamic references
