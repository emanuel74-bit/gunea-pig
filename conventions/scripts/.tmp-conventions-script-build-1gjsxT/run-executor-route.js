...
import { getArg, readExecutorRoutes, resolveConventionsRoot } from "./lib/common.js";
...
function collectChangedFiles(hookInput) {
    const files = new Set();
    const candidates = [
...
function writeHookOutput(ok, message, details = {}) {
