...
if (!revisionRel) {
  ...
  try {
    ...
    if (task.generated_by !== "create-revision-task") issues.push(issue("error", "REVISION_TASK_NOT_SCRIPT_PRODUCED", "Revision task must be generated by create-revision-task; agents/Alpha may not manually author revision decisions.", revisionRel));
