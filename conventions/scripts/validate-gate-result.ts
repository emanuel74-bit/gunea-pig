...
if (!resultRel) {
  ...
  try {
    ...
    if (result.generated_by !== "run-gate-check") issues.push(issue("error", "GATE_RESULT_NOT_SCRIPT_PRODUCED", "Gate result must be generated by run-gate-check; agents may not manually author gate decisions.", resultRel));
