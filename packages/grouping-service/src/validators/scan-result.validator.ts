...
/**
 * Validator role — validates the NormalizedScanResult schema loaded from S3.
 * Runs at the application boundary before any persistence occurs.
 * Throws ScanResultValidationError for any structural or semantic violation.
 */
